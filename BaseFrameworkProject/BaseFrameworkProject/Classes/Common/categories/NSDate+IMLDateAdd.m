...
- (NSString *)timeIntervalDescription
{
    ...
    else// if (timeInterval < 2592000)
    {
        ...
        //return [NSString stringWithFormat:NSLocalizedString(@"NNNN年M月d日", @"") ];//timeInterval / 86400
...
#pragma mark - Convert date into string or on the contrary

+ (NSDate *)dateFromString:(NSString *)string {
    NSDateFormatter *fomatter = [NSDateFormatter defaultDateFormatter];
...
+ (NSInteger)daysOfMonth:(NSString *)aDate {
    ...
    NSDate *date = [NSDate dateFromString:aDate];
...
+ (NSInteger)weeksOfYear:(NSString *)aDate {
    ...
    NSCalendar *calender = [NSCalendar currentCalendar];
    NSRange weeks = [calender rangeOfUnit:NSCalendarUnitWeekOfYear inUnit:NSCalendarUnitYear forDate:date];
...
- (NSInteger)weeksOfYear {
    ...
    NSCalendar *calender = [NSCalendar currentCalendar];
    NSRange weeks = [calender rangeOfUnit:NSCalendarUnitWeekOfYear inUnit:NSCalendarUnitYear forDate:self];
